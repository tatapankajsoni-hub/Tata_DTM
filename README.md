...
The browser application uses same-origin FastAPI endpoints only. It does not use Supabase.
The Render service must use the SAME `DATABASE_URL` (Render PostgreSQL Internal Database URL) as the DTM Management Reporting service.
